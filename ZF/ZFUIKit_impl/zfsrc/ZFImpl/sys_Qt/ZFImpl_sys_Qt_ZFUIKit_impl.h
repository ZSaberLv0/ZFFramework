...
extern ZF_ENV_EXPORT void ZFImpl_sys_Qt_viewInfoT(ZF_OUT zfstring &ret, ZF_IN QWidget *view);
inline zfstring ZFImpl_sys_Qt_viewInfo(ZF_IN QWidget *view)
{
    zfstring ret;
...
extern ZF_ENV_EXPORT void ZFImpl_sys_Qt_viewTreePrintT(ZF_OUT zfstring &ret, ZF_IN QWidget *view);
inline zfstring ZFImpl_sys_Qt_viewTreePrint(ZF_IN QWidget *view)
{
    zfstring ret;
