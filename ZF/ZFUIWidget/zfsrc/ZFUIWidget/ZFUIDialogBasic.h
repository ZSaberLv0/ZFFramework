...
public:
    ...
    ZFPROPERTY_ON_VERIFY_DECLARE(ZFUIDialogContent *, dialogContent)
    ZFPROPERTY_ON_ATTACH_DECLARE(ZFUIDialogContent *, dialogContent)
    ZFPROPERTY_ON_DETACH_DECLARE(ZFUIDialogContent *, dialogContent)
